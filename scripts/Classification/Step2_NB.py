...
def gaussian_nb_nested_cv(inp, prefix, feature_selection_method):
    ...
    plt.title('Confusion Matrix for GaussianNB',fontsize=12,fontweight='bold')
    ...
    plt.title('ROC Curves for GaussianNB', fontsize=22, fontweight='bold', pad=15)
    ...
    plt.title('Performance Metrics for GaussianNB',fontsize=14,fontweight='bold')
    plt.ylabel('Value')
    plt.ylim(0, 1.1)
