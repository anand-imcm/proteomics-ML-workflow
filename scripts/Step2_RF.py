...
def random_forest(inp,prefix):
    ...
    plt.savefig(f"{prefix}_random_forest_confusion_matrix.png")
    plt.close()
    ...
    plt.savefig(f"{prefix}_random_forest_roc_curve.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f"{prefix}_random_forest_metrics.png")
    plt.close()