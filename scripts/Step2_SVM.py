...
def svm(inp, prefix):
    ...
    def objective(trial):
        ...
        clf = SVC(kernel='rbf', C=C, gamma=gamma, probability=True, random_state=1234)
    ...
    best_model = SVC(kernel='rbf', C=best_C, gamma=best_gamma, probability=True, random_state=1234)
