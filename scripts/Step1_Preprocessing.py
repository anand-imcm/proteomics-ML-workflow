...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description="Script to perform dimentionality reduction of the dataset.")
...
def perform_pca(data, out_prefix, labels, dims=15, standardize=True, random_state=42):
    if standardize:
