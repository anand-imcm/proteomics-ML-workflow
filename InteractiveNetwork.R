...
# Inputs: g - A network object; nodeName, nodeColor, nodeShape, nodeValue - Attributes of the nodes in the network. myTitle - Title for the color bar legend, representing the range of SHAP values for the nodes.
# Output: - An HTML file named "Interactive_PPI.html" containing the interactive network visualization.
...
#-------------------------------------------------
# Main to make the interactive network plot
