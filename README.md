...
<span style="color:#999999; font-style:italic;">&#444; Note:</span> We recommend that users adopt *unique Entrez Symbols* as the protein naming convention for our network analysis. We also provide an approach using the R/Bioconductor annotation package **`org.Hs.eg.db`** to map UniProt IDs to Entrez Gene Symbols.
