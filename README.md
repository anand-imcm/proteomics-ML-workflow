...
- **Optional**
  ...
  - **`main.memory_*`** : [Int] Amount of memory in GB needed to execute the specific task. Default value: `64`
  - **`*main.cpu_*`** : [Int] Number of CPUs needed to execute the specific task. Default value: `32`
